...
<div class="container-fluid">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb my-0 ms-2">
            ...
            <li class="breadcrumb-item active"><span>Update Role</span></li>
        </ol>
    </nav>
</div>
</header>
        ...
        <form method="post" action="">
            ...
            <div class="row">
                ...
                <div class="mb-3 col-4">
                    ...
                    <input type="text" class="form-control" name="role" value="<?php echo e($role->role); ?>">
                </div>
                    <div class="mb-3 col-4">
                        <label for="formGroupExampleInput" class="form-label">Status</label>
                        <select name="status" class="form-control">
                            <option value="1" <?php echo e($role->status === 1 ? 'selected' : ''); ?>>Active</option>
                            <option value="0" <?php echo e($role->status === 0 ? 'selected' : ''); ?>>Inactive</option>
                        </select>
                    </div>
                    <?php
                                        ...
                                        <?php $__currentLoopData = $category->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="checkbox[]" value="<?php echo e($child->id); ?>" <?php if(in_array($child->id, $permission)): ?> checked <?php endif; ?>>
...
<?php /**PATH /home/bazarcenter/public_html/staging.bazarcenter.ca/admin/Modules/Role/Resources/views/details.blade.php ENDPATH**/ ?>