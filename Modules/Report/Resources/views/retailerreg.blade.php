...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Retailer Demographic Reports</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Retailer Demographic Reports</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var empTable = $('#users-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url:"{{ url('report/retailer-reg-data')}}",
                data: function(data){
        ...
        $('#export-btn').click(function () {
            ...
            $.ajax({
                url: '{{ url('report/export-retailer-reg')}}',
                type: 'GET',
                data: {
